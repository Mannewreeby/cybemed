...
class _MyAppState extends State<MyApp> {
  ...
  final roomText = TextEditingController(text: "Cybemed_Flutter_Jitsi_test_room");
  final subjectText = TextEditingController(text: "Flutter Test Meeting");
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: Scaffold(
        appBar: AppBar(
          title: const Text('Premicare Home'),
